...
<div id="container">
	<div class="nav">
		...
		<img src="img/conus.jpg" style="width:1150px; height:250px; border:1px solid #000; ">
	<br />
	<br />
		...
		<div id="content">
			<form method="post">
				<table style="position:relative; left:25%;">
					...
					<tr>
						<td style="font-size:20px;">Message:</td><td><textarea name="message" style="width:400px; height:150px;" required></textarea></td>
					</tr>
					<tr>
		...
		<?php
			...
			if(isset($POST['send']));
			{
				...
				$conn->query ("INSERT INTO `contact` (email, message) VALUES ('$email', '$message')") or die (mysqli_error($conn));
			}
		?>
