...
?>
	...
	<input type="hidden" name="cmd" value="_xclick" />
        <input type="hidden" name="business" value="20bcuos019@ddu.ac.in" />
        ...
        <input type="hidden" name="currency_code" value="Price" />
        <input type="hidden" name="lc" value="GB" />
        <input type="hidden" name="bn" value="Easy Payment by Nishit" /><br />
