...
<div id="container">
	<div class="nav">
		...
		<img src="img/aboutus.jpg" style="width:1150px; height:250px; border:1px solid #000; ">
	<br />
	<br />
	...
	<legend>About Us</legend>
		<div id="content">
			<legend><h3>Mission</h3></legend>
					<h4 style="text-indent:60px;">To Provide the Comfort to our customers with the reasonable price and provide better quality.</h4>
			<br />
				<legend><h3>Vision</h3></legend>
					<h4 style="text-indent:60px;">StepIn T&N Co. , the company that inspire, motivate, and give determination to the sports enthusiast.</h4>
			<br />
