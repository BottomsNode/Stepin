...
<div id="container">
	...
	<div class="nav1">
		<ul>
			<li><a href="product.php">Cricket</a></li>
			<li>|</li>
			<li><a href="football.php" >Football</a></li>
			<li>|</li>
			<li><a href="running.php" class="active" style="color:#111;">Running/Casual</a></li>
		</ul>
	</div>
	...
	<div id="content">
		...
		<div id="product">
			...
			<?php
				...
				$query = $conn->query("SELECT *FROM product WHERE category='running' ORDER BY product_id ASC") or die (mysqli_error($conn));
