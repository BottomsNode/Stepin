<?php
$paypal_id='20bcuos019@gmail.com'; // Business email ID
?>
<?php
...
<div id="container">
	...
	<label style="font-size:25px;">Summary of Orders</label>
		...
		$query2 = $conn->query("SELECT * FROM transaction_detail LEFT JOIN product ON product.product_id = transaction_detail.product_id WHERE transaction_detail.transaction_id = '$t_id'") or die (mysqli_error($conn));
	...
	<legend></legend>
	<h4>TOTAL Price :<?php echo $amnt; ?></h4>
	</form>
...
<div class="">
    ...
    <input type="hidden" name="item_name" value="shoesdb Shoes">
    ...
    <input type="image" src="https://www.sandbox.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="Pay Safer - The Safer, easier way to pay online!">
