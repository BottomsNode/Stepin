		...
		<div id="login" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				...
				<div class="modal-body">
					<center>
							<img src="img/slogo.png" width="300" height="250">
					</center><br>
					<form method="post">
					<center>
		...
		<div id="signup" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				<div class="modal-header">
					...
					<form method="post">
						...
						<input type="text" name="country" placeholder="State" required>
...
<div id="container">
	<div class="nav">
			 ...
			 <ul>
				...
				<li><a href="privacy.php"><i class="icon-info-sign"></i>Our Policy</a></li>
			</ul>
	</div>
	...
	<div id="carousel">
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="img/b1.jpg" class="carousel"></div>
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/b2.jpeg" class="carousel"></div>
	...
	<div id="content">
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h2><legend>Our Featured Highlights</legend></h2></center>
			<br/>
			<?php

				$query = $conn->query("SELECT *FROM product WHERE category='feature' ORDER BY product_id DESC") or die (mysqli_error($query));
					...
					while($fetch = $query->fetch_array())
						...
						$query1 = $conn->query("SELECT * FROM stock WHERE product_id = '$pid'") or die (mysqli_error($query));
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;"></a>Wonderland shoes gives you many Varieties Since 2022</p>
		</div>
