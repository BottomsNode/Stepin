...
<div id="container">
	...
	<div class="nav1">
		<ul>
			<li><a href="product.php" class="active" style="color:#111;">Cricket</a></li>
			<li>|</li>
			<li><a href="football.php">Football</a></li>
			<li>|</li>
			<li><a href="running.php">Running/Casual</a></li>
		</ul>
	...
	<div id="content">
		...
		<div id="product">
			...
			include ('function/addcart.php');
				...
				$query = $conn->query("SELECT *FROM product WHERE category='Cricket' ORDER BY product_id ASC") or die (mysqli_error($conn));
